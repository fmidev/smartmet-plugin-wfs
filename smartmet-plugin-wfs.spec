...
BuildRequires: smartmet-engine-contour-devel >= 24.11.1
BuildRequires: smartmet-engine-geonames-devel >= 24.11.1
BuildRequires: smartmet-engine-gis-devel >= 24.11.1
BuildRequires: smartmet-engine-grid-devel >= 24.11.1
BuildRequires: smartmet-engine-querydata-devel >= 24.11.1
BuildRequires: smartmet-library-grid-content-devel >= 24.10.23
BuildRequires: smartmet-library-grid-files-devel >= 24.10.23
%if %{with observation}
BuildRequires: smartmet-engine-observation-devel >= 24.11.1
%endif
Requires: ctpp2
...
Requires: smartmet-engine-contour >= 24.11.1
Requires: smartmet-engine-geonames >= 24.11.1
Requires: smartmet-engine-gis >= 24.11.1
Requires: smartmet-engine-grid >= 24.11.1
Requires: smartmet-library-grid-content >= 24.10.23
Requires: smartmet-library-grid-files >= 24.10.23
%if %{with observation}
Requires: smartmet-engine-observation >= 24.11.1
%endif
Requires: smartmet-engine-querydata >= 24.11.1
...
#TestRequires: smartmet-library-macgyver >= 24.10.28
#TestRequires: smartmet-library-gis >= 24.8.7
#TestRequires: smartmet-library-newbase >= 24.10.15
#TestRequires: smartmet-library-spine-plugin-test >= 24.10.15
#TestRequires: smartmet-engine-geonames >= 24.11.1
#TestRequires: smartmet-engine-gis >= 24.8.7
#TestRequires: smartmet-engine-querydata >= 24.11.1
%if %{with observation}
#TestRequires: smartmet-engine-observation >= 24.11.1
%endif
#TestRequires: smartmet-engine-grid >= 24.11.1
#TestRequires: redis
