...
void Plugin::init()
{
  try
  {
    ...
    itsReactor->addAdminBoolRequestHandler(
        ...
        [this](Spine::Reactor&, const Spine::HTTP::Request&) -> bool { return reload(itsConfig); },
    ...
    itsReactor->addAdminCustomRequestHandler(
        ...
        "wfs:xmlSchemaCache",
        false,
        [this](Spine::Reactor&, const Spine::HTTP::Request& theRequest, Spine::HTTP::Response& theResponse) {
        ...
        [this](Spine::Reactor&, const Spine::HTTP::Request& theRequest, Spine::HTTP::Response& theResponse) {
          if (authenticateRequest(theRequest, theResponse))
          {
            ...
            if (format and *format == "json") {
                ...
                plugin_impl.load()->dump_constructor_map_html(content, handler);
                theResponse.setStatus(200);
